...
/**
 * Creates the localized validation schema for organization creation and for
 * editing organization details on the settings page — both collect the same
 * fields, so one schema serves both.
 */
